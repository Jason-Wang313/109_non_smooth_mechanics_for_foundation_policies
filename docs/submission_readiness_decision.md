...
Honest strongest claim: `Bring contact discontinuities into the policy objective instead of smoothing them away.` is a plausible branch-structured mechanism for classical mechanics and robot foundation models, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
