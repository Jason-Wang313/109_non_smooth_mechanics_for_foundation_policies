...
This repository contains a hardened, honest workshop-only robotics paper draft for `non_smooth_mechanics_for_foundation_policies`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/109.pdf`
