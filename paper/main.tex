...
\usepackage{url}
\usepackage{booktabs}
\title{Non-Smooth Mechanics for Foundation Policies: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about classical mechanics and robot foundation models. The original research bet was: Bring contact discontinuities into the policy objective instead of smoothing them away. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Modeling Large Sliding Frictional Contact Along Non-Smooth Discontinuities in X-FEM (2011)
\item An Efficient Spring Model Based on a Curved Beam with Non-Smooth Contact Mechanics for Valve Train Simulations (2010)
\item Generalization of hyperbolic smoothing approach for non-smooth and non-Lipschitz functions (2022)
\item Simulation of a Valve Train Using Non-Smooth Mechanics (2008)
\item A variational-based non-smooth contact dynamics approach for the seismic analysis of historical masonry structures (2024)
\end{itemize}
